...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void _sendMessage({String text, File imgFile}) async {
    ...
    if(user == null) {
      _scaffoldKey.currentState.showSnackBar(
        SnackBar(content: Text('Não foi possivel fazer o login. Tente novamente!'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(
        title: Text(_currentUser != null ? 'Olá, ${_currentUser.displayName}' : 'Chat online'),
        elevation: 0,
        centerTitle: true,
        actions: <Widget>[
                  ...
                  default:
                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return ChatMessage(list[index].data, list[index].data['uid'] == _currentUser?.uid);
                      }
                    );
                }
              },
